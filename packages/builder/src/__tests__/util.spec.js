...
test('should correct getCompDetailById', () => {
  ...
  var value2 = getCompDetailById('aaa1', schema)
...
test('should correct wrap schema', () => {
  ...
  expect(value3).not.toHaveProperty('properties.wrapper.properties.name.__id__')
  expect(value3).toHaveProperty('properties.wrapper.properties.name.key')
  expect(value3).not.toHaveProperty('properties.wrapper.properties.name.width')
  expect(value3).not.toHaveProperty('properties.wrapper.properties.name.height')
  expect(value3).not.toHaveProperty('properties.wrapper.properties.name.active')
})
