export default {
  ...
  nl: {
    pattern: 'Dit veld komt niet overeen met het verwachte patroon',
    invalid: 'Dit veld is ongeldig',
    required: 'Dit veld is verplicht',
    number: 'Dit veld moet numeriek zijn',
    integer: 'Dit veld moet een geheel getal bevatten',
    url: 'Dit veld moet een url bevatten',
    email: 'Dit veld moet een geldig e-mailadres bevatten',
    ipv6: 'Dit veld moet een ip-adres in ipv6-formaat bevatten',
    ipv4: 'Dit veld moet een ip-adres in ipv4-formaat bevatten',
    idcard: 'Dit veld moet een geldig id-nummer bevatten',
    qq: 'Dit veld moet een qq-nummer bevatten',
    phone: 'Dit veld moet een geldig telefoonnummer bevatten',
    money: 'Dit veld moet een geldig bedrag bevatten',
    zh: 'Dit veld moet een geldige chinese tekst bevatten',
    date: 'Dit veld moet een geldige datum bevatten',
    zip: 'Dit veld moet een geldige postcode bevatten',
    len: 'De lengte/het aantal van dit veld moet {{len}} zijn',
    min: 'De lengte/het aantal van dit veld moet minimaal {{min}} zijn',
    minLength: 'Dit veld moet minimaal {{minLength}} tekens lang zijn',
    minItems: 'Het aantal items moet minimaal {{minItems}} zijn',
    maximum: 'De waarde kan niet groter zijn dan {{maximum}}',
    exclusiveMaximum: 'De waarde moet minder zijn dan {{exclusiveMaximum}}',
    minimum: 'De waarde kan niet minder zijn dan {{minimum}}',
    exclusiveMinimum: 'De waarde moet groter zijn dan {{exclusiveMinimum}}',
    max: 'De lengte/het aantal kan niet méér zijn dan {{max}}',
    maxLength: 'Dit veld mag niet langer zijn dan {{maxLength}}',
    maxItems: 'Het aantal items mag niet méér zijn dan {{maxItems}}',
    whitespace: 'Dit veld kan niet leeg zijn',
    enum: 'Dit veld moet één van deze waardes bevatten: {{enum}}',
    const: 'Het veld moet deze waarde bevatten: {{const}}',
    multipleOf: 'Het veld moet een veelvoud zijn van {{multipleOf}}',
    maxProperties:
      'Het aantal waardes kan niet méér zijn dan {{maxProperties}}',
    minProperties:
      'Het aantal waardes kan niet minder zijn dan {{maxProperties}}',
    uniqueItems: 'Alle waardes moeten uniek zijn',
  },
  zh: {
