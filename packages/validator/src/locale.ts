export default {
  ...
  'pt-BR': {
        ...
        number: 'O valor do campo não é um número',
        integer: 'O valor do campo não é um número inteiro',
        url: 'O valor do campo não é uma URL',
        email: 'O valor do campo não é um email',
        ipv6: 'O valor do campo não é um ipv6',
        ipv4: 'O valor do campo não é um ipv4',
        idcard: 'O valor do campo não é um número de ID',
        qq: 'O valor do campo não é um número qualquer',
        phone: 'O valor do campo não é um número de telefone',
        money: 'O valor do campo não é uma moeda',
        zh: 'O valor do campo não é uma string chinesa',
        date: 'O valor do campo não é uma data',
        zip: 'O valor do campo não é um número de cep',
        len: 'O valor do campo ultrapassa o limite de tamanho {{len}}',
        min: 'O comprimento ou o número de entradas deve ser de pelo menos {{min}}',
        minLength: 'O comprimento ou o número de entradas deve ser de pelo menos {{minLength}}',
        minItems: 'O comprimento ou o número de entradas deve ser de pelo menos {{minItems}}',
        maximum: 'O valor do campo não pode ser maior que {{maximum}}',
        exclusiveMaximum: 'O valor do campo deve ser menor que {{exclusiveMaximum}}',
        minimum: 'O valor do campo não pode ser menor que {{minimum}}',
        exclusiveMinimum: 'O valor do campo deve ser maior que {{exclusiveMinimum}}',
        max: 'O comprimento do campo ou número de entradas deve ser no máximo {{max}}',
        maxLength: 'O comprimento do campo ou número de entradas deve ser no máximo {{maxLength}}',
        maxItems: 'O comprimento do campo ou número de entradas deve ser no máximo {{maxItems}}',
        whitespace: 'Este valor de campo não pode ser uma string em branco.',
        enum: 'O valor do campo deve ser um dos {{enum}}',
        const: 'O valor do campo deve ser divisível por {{const}}',
        multipleOf: 'The field value must be divisible by {{multipleOf}}',
